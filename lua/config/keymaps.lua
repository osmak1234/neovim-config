...
-- navigates to term 1
map("n", "<leader>8", "<cmd>lua require('harpoon.term').gotoTerminal(1)<cr>", { desc = "Harpoon go to term 1" })
map("n", "<leader>9", "<cmd>lua require('harpoon.term').gotoTerminal(1)<cr>", { desc = "Harpoon go to term 1" })
map("n", "<leader>0", "<cmd>lua require('harpoon.term').gotoTerminal(1)<cr>", { desc = "Harpoon go to term 1" })
